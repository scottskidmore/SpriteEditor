...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCanvasENDCLASS_t qt_meta_stringdata_CLASSCanvasENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(7, 11),  // "gridClicked"
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 12),  // "updateCanvas"
        QT_MOC_LITERAL(33, 17)   // "std::list<QImage>"
    },
    "Canvas",
    "gridClicked",
    "",
...
Q_CONSTINIT const QMetaObject Canvas::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCanvasENDCLASS_t,
        ...
        // method 'updateCanvas'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<std::list<QImage>, std::false_type>
    >,
    nullptr
} };
...
void Canvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->gridClicked((*reinterpret_cast< std::add_pointer_t<QPoint>>(_a[1]))); break;
        case 1: _t->updateCanvas((*reinterpret_cast< std::add_pointer_t<std::list<QImage>>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Canvas::gridClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Canvas::gridClicked(QPoint _t1)
{
